...
// NewFileLogger opens the logging file specified and redirects log output to both file and stdout.
// It then returns pointer to Logger object
func NewFileLogger(path string) (*Logger, error) {
	...
	return &Logger{
		fileHandle:  f,
		infoLogger:  log.New(infoMultiWriter, "INFO: ", log.Ldate|log.Ltime|log.Lmsgprefix),
		errorLogger: log.New(errMultiWriter, "ERROR: ", log.Ldate|log.Ltime|log.Lmsgprefix),
	}, nil
}